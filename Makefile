...
# CFLAGS += -std=c11 -Wall -g -D_XOPEN_SOURCE_EXTENDED -D_XOPEN_SOURCE -D_FILE_OFFSET_BITS=64 -lpthread -lcurl
CFLAGS += -std=c11 -Wall -g -D_XOPEN_SOURCE_EXTENDED -D_XOPEN_SOURCE -D_FILE_OFFSET_BITS=64 -lpthread
